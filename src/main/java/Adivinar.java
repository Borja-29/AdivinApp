...
public class Adivinar extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		introduceNumero.setText("Introduce un número del 1 al 100");
		...
		try {
			...
			if (a >= 1 && a <= 100) {
				if(a == aleatorio) {
					...
					if(a<aleatorio)
						falloAlerta.setContentText("El número a adivinar es mayor que "+a+".\n\n Vuelve a intentarlo.");
					else
						falloAlerta.setContentText("El número a adivinar es menor que "+a+".\n\n Vuelve a intentarlo.");
